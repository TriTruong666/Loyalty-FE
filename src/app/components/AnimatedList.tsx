...
interface AnimatedListProps {
  items?: ReactNode[]; // ⬅️ đổi từ string[] sang ReactNode[]
  onItemSelect?: (item: ReactNode, index: number) => void; // cũng đổi kiểu item
    ...
    <div className={`relative w-full ${className}`}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`p-4 bg-[#111] rounded-lg hover:bg-neutral-700 hover:bg-opacity-50 transition-all duration-500 ${
